...
#define CALLBACK_SERVICE(SERVICE, HANDLERS)                                          \
  class SERVICE##WithCallbacks final : public SERVICE::ExperimentalCallbackService { \
   public:                                                                           \
...
#define UNARY_CALLBACK_RPC_SERVICE_HANDLER(SERVICE, HANDLER)                          \
  grpc::experimental::ServerUnaryReactor *HANDLER(                                    \
      grpc::experimental::CallbackServerContext *context,                             \
      const HANDLER##Request *request, HANDLER##Reply *reply) {                       \
